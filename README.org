...
- No completion function found for <type>:
  ...
  - point is on <path> => call `org-link-completion-capf-path-unknown-type' variable (default: org-link-completion-capf-path-unknown-type-default function)
  - point is on <desc> => call `org-link-completion-capf-desc-unknown-type' variable (default: org-link-completion-capf-desc-unknown-type-default function)
