...
- Point is in <type> => org-link-completion-type variable (default: org-link-completion-type-default function)

- <type> is empty:
   - Point is in <path> => org-link-completion-path-untyped variable (default: org-link-completion-path-untyped-default function)
   - Point is in <desc> => org-link-completion-desc-untyped variable (default: org-link-completion-desc-untyped-default function)
...
- No completion function found for <type>:
  ...
  - point is on <path> => call `org-link-completion-path-unknown-type' variable (default: org-link-completion-path-unknown-type-default function)
  - point is on <desc> => call `org-link-completion-desc-unknown-type' variable (default: org-link-completion-desc-unknown-type-default function)
