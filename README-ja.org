...
- ポイントが<type>の部分にある => org-link-completion-type 変数(デフォルト: org-link-completion-type-default 関数)

- <type>が空:
  - ポイントが<path>の部分にある => org-link-completion-path-untyped 変数(デフォルト: org-link-completion-path-untyped-default 関数)
  - ポイントが<desc>の部分にある => org-link-completion-desc-untyped 変数(デフォルト: org-link-completion-desc-untyped-default 関数)
...
- <type>に対する補完関数が見つからない:
  - ポイントが<path>の部分にある => org-link-completion-path-unknown-type 変数(デフォルト: org-link-completion-path-unknown-type-default 関数)
  - ポイントが<desc>の部分にある => org-link-completion-desc-unknown-type 変数(デフォルト: org-link-completion-desc-unknown-type-default 関数)
